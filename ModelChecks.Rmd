...
predictions = as.data.frame(
  exp(predict(lm1, newdata=paint_test, 
              interval = "pred")))
save(predictions, file="predict-test.Rdata")
```

### AV Plot to drop variables

```{r}
# BMA
# year dealer difforigin expensive authorstyle endbuyer Interm Surface matericalcat # engraved prevcoll paired finished lrgfont lands_elem 

avPlots(lm(logprice ~ year + dealer + diff_origin + expensive + authorstyle + endbuyer + Interm + Surface + materialCat + engraved + prevcoll + finished + lrgfont + lands_elem, data = paint_train))

# RF 
# expensive year Surface dealer endbuyer materialCat origin_cat paired lrgfont finished
```
