...
First of all, all the interactions are not that important but still have influence on the price. The most important variables are `Surface`, `lrgfont`, `prevcoll`, `origin_cat`, `finished` ,`dealer`, `year`.
