...
#    authorstyle + endbuyer + Interm + log(Surface) + engraved + prevcoll + 
#    paired + finished + lrgfont + lands_sc + discauth)^2, data = paint_train)
...
#                   year:endbuyer + year:log(Surface) + year:discauth + 
                   #artistliving:authorstyle + artistliving:discauth + 
                   #authorstyle:log(Surface) + endbuyer:finished + 
#                   endbuyer:discauth + Interm:log(Surface) + Interm:prevcoll + 
#                   Interm:lrgfont + Interm:discauth + log(Surface):discauth + 
