...
Next, we considered interaction terms for our predictor variables. We again used intuition as our method for introducing interactions in the model. 
...
g_interact <- lm(formula = logprice ~ log(Surface) + lrgfont + Interm + authorstyle + 
    ...
    dealer + lands_sc + endbuyer + year + authorstyle:log(Surface) + Interm:log(Surface) +
      log(Surface):discauth + year:endbuyer + 
      endbuyer:dealer, data = paint_train)
