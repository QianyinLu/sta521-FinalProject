...
```
Imbalanced classes can lead to unstable estimates if the underrepresented class does not have a sufficient amount of data. This was our motivation to remove any variable that had less than an arbitrary 100 observations in a class, which is denoted by the dotted black line in our visualization above. 
