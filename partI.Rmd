...
For categorical variables: 
 ...
 - *other*,*pastorale*,*allegory*,*history*, *lands_ment*,*original*, *type_intermed*, and *Shape* have serious **class imbalance** problem, where certain value is seldomly observed. So we will discard these variables in modeling.    
...
- *singlefig*, *figures* and *nfigures* have quite similar information about number of figures related to paintings. According to the following graph, *logprice* seems have more obvious difference with various values of *nfigures*, so dropped the other two.
