...
model_ini <- lm(logprice ~ year + dealer + origin_cat + diff_origin + 
                         authorstyle + endbuyer + Interm + Surface + materialCat + 
                         prevcoll + paired + finished + lrgfont + 
                         lands_elem + othgenre + (year + authorstyle):dealer, data = paint_train)
...
```{r}
new_lm <- lm(logprice ~ year + dealer + diff_origin + 
                         authorstyle + endbuyer + Interm + Surface + materialCat + 
                         prevcoll + paired + finished + lrgfont + 
                         lands_elem + year:dealer, data = paint_train)
