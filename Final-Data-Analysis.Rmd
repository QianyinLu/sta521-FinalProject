...
'authorstyle' has a ton of na's that are coded in as "n/a". could be turned into factor

'author' name of author. Redundant to 'authorstandard'. We might prefer 'authorstandard'

'winningbidder' name of winning bidder. looks fine, could be important
...
'material' should be factor and there are blanks instead of NA's
