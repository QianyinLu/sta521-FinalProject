...
The 'sale' column is merely a combination of 'dealer' and 'year', and could be dropped immediately, as it introduces no additional information. 

'Lot' would make sense to be a numeric, however, there are some entries with letters in them. Coercing to numeric would cause errors.  

'position' is supposed to be a percentage, yet there are a few entries over 1. This implies that there is a data misentry problem here, and these entries should be divided by 100 to be correctly formatted. 
...
'origin_cat' should be a factor with 5 levels.
