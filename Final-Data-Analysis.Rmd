...
```{r EDA, cache = T, warning=F}
paintings_train$lot = as.numeric(paintings_train$lot)
ggpairs(paintings_train, columns = c(10, 2:7),
lower = list(continuous = wrap("points", alpha = 0.5, size = 0.3)), progress = F)+
theme(axis.text.x = element_text(angle = 45, hjust = 1))

```

```{r}
ggpairs(paintings_train, columns = c(10,8,9,12,15,16,19),
lower = list(continuous = wrap("points", alpha = 0.5, size = 0.3)), progress = F)+
theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
```{r}
ggpairs(paintings_train, columns = c(10,20,21,22,23,24,25),
lower = list(continuous = wrap("points", alpha = 0.5, size = 0.3)), progress = F)+
theme(axis.text.x = element_text(angle = 45, hjust = 1))
```

```{r}
ggpairs(paintings_train, columns = c(10,28,29,32,33,34,35),
lower = list(continuous = wrap("points", alpha = 0.5, size = 0.3)), progress = F)+
theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
